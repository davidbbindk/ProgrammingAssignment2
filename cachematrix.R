## cachematrix.R
##
##Spawn a matrix, enable inversing using solve() - if it the first time it is done calculate otherwise use cached version
##as part of Rprog-014 course.
##usage defined by teacher
##
## Usage:
